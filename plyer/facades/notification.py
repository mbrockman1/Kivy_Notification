...
class Notification:
    ...
    def notify(self, title='title', message='message', timing=5, app_name='',
               app_icon='', timeout=10, ticker='', toast=False, repeat=False):
        '''
        Send a notification.
        ...
        self._notify(
            ...
            timeout=timeout, ticker=ticker, toast=toast, repeat=repeat
        )
